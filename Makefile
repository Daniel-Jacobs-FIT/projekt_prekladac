...
ALL-OBJS=${SCANNER-TEST-OBJS} ${SCANNER-LIB-OBJS} ${SYMTAB-TEST-OBJS} ${SYMTAB-LIB-OBJS} ${BOTUP-PARSER-LIB-OBJS} ${BOTUP-PARSER-TEST-OBJS} ${PSA-STACK-LIB-OBJS} ${PSA-STACK-TEST-OBJS} ${TOPDOWN-PARSER-LIB-OBJS} ${TOPDOWN-PARSER-TEST-OBJS}
...
${TOPDOWN-PARSER-TEST-NAME}: ${TOPDOWN-PARSER-LIB-OBJS} ${TOPDOWN-PARSER-TEST-OBJS} ${SCANNER-LIB-OBJS} ${SYMTAB-LIB-OBJS} ${PSA-STACK-LIB-OBJS}
	${CC} ${CFLAGS} $^ -o $@
